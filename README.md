...
<a href="https://github.com/theodoku/hello-world-back-end">BackEnd is here</a>
...
In order to run this project you need to setup the back-end using [this repo](https://github.com/theodoku/hello-world-back-end.git) on your machine, Make sure you have installed [nodejs](https://nodejs.org).
...
```sh
  git clone https://github.com/theodoku/hello-world-front-end.git
```
